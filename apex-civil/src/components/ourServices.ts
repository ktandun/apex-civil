...
export const ourServices: OurService[] = [
  {
    ...
    image: new URL('../assets/our-services.jpg', import.meta.url).href,
    ...
    points: [
      {
        image: new URL('../assets/our-services-point.svg', import.meta.url).href,
        title: 'Earthworks',
  ...
  },
  {
    ...
    image: new URL('../assets/land-development.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    image: new URL('../assets/project-management.jpg', import.meta.url).href,
