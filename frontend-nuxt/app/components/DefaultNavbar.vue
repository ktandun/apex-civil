<template>
  <div class="navbar-wrapper" id="navbar">
    ...
    <div class="nav-links-mobile">
      <NuxtLink :to="{ name: 'our-services' }">Our Services</NuxtLink>
      <NuxtLink :to="{ name: 'key-projects' }">Key Projects</NuxtLink>
      <NuxtLink :to="{ name: 'contact-us' }">Contact Us</NuxtLink>
    </div>
  </div>
</template>
